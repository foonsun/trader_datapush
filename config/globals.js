...
module.exports.globals = {
  market             : [{market:'ELOT/ETH',coin:'elottery token'},
                        {market:'ELOT/BTC',coin:'elottery token'},
                        {market:'ETH/BTC',coin:'Ethereum'},
                        {market:'EOS/ETH',coin:'EOS'},
                        {market:'EOS/BTC',coin:'EOS'}
                        ],
  interval           : [ 604800,86400,14400,7200,3600,1800,900,300,60 ],
  server_viabtc      : "http://150.95.176.60:8080",
  ws_viabtc          : "ws://150.95.176.60:8090",
  interval_param     : 86400,
  no_data_sleep      : 1000,
  host               : '127.0.0.1', 
  port               : 6379, 
  ns                 : 'rsmq',
